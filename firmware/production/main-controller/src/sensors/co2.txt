...
const float LIMIAR_STDDEV_V = 0.020; // 15 mV -> limite de estabilidade
...
unsigned long agoraMs = millis();
  ...
  if (contagemAnel == 1 && mediaSuavizada == 0.0) mediaSuavizada = mediaV; // inicializa na primeira amostra
  ...
  float Vcorrigida = mediaSuavizada; // se quiser aplicar A/B no sinal: Vcorrigida = A_cal * mediaSuavizada + B_cal;
